<template>
  <div class="questioncontainer d-flex text-left flex-column align-items-left justify-content-start">
    ...
    <textarea v-show="!questioncomplete" v-model.lazy="questiontext" name="question" id="question" cols="30" rows="10"
      class="questiontextfield"></textarea>
    <div class="questionText" v-show="questioncomplete" ref="question"
      style="word-break: break-all; padding: 8px; font-size: 17px;">{{ questiontext }}</div>
    ...
    <div class="d-flex flex-column align-items-start justify-content-start">
      <span class="w-100" v-for="(option, optionIndex) in numberOptions" :key="optionIndex">
        <div class="d-flex justify-content-around w-100">
          <input type="radio" ref="radio" name="selectanswer" :value="optionIndex" class="radio"
